...
public class UserController implements UserApi {
    ...
    public ActivityDto getActivity(String email, String activity) {
        return userService.getActivity(email, activity);
    }


    public ActivityDto updateActivity(String email, ActivityDto activityDto) {
        return userService.updateActivity(email, activityDto.getActivityName(), activityDto);
    }


    public ActivityDto addActivityTime(String email, String activity, Long seconds) {
