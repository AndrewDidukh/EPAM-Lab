...
public class UserAssembler extends RepresentationModelAssemblerSupport<UserDto, UserModel> {
    ...
    public UserModel toModel(UserDto entity) {
        ...
        Link addTime = linkTo(methodOn(UserController.class).addActivityTime(entity.getEmail(), null,0)).withRel(ADD_TIME);


        userModel.add(getU,createU,updateU,deleteU,getA,createA,deleteA,addTime);
